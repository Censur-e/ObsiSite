    ...
    <div className="landing min-h-screen bg-background text-foreground">
      <nav className="fixed top-0 inset-x-0 z-50 landing-nav">
        <div className="container flex items-center justify-between h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-muted-foreground"><a href="#features" className="landing-link">Fonctionnalités</a><a href="#plans" className="landing-link">Formules</a><a href="https://discord.gg/sFcAYQhcXR" target="_blank" rel="noreferrer" className="landing-link text-[#aeb8ff]">Discord</a><span className="flex items-center gap-2 text-emerald-400"><span className="status-dot" /> Système opérationnel</span></div>
